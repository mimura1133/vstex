...
{
    /// <summary>
    ///     Used by a project to query the environment for permission to add, remove, or rename a file or directory in a
    ///     solution
    /// </summary>
    internal class TrackDocumentsHelper
    {
        ...
        internal bool CanAddItems(string[] files, VSQUERYADDFILEFLAGS[] flags)
        {
            ...
            ErrorHandler.ThrowOnFailure(GetIVsTrackProjectDocuments2()
                .OnQueryAddFiles(projectMgr.InteropSafeIVsProject3, len, files, flags, summary, null));
