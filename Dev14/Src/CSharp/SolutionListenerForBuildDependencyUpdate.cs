...
namespace VsTeXProject.VisualStudio.Project
{
    ...
    internal class SolutionListenerForBuildDependencyUpdate : SolutionListener
    {
        ...
        public override int OnAfterOpenProject(IVsHierarchy hierarchy, int added)
        {
            ...
            var projectNode = hierarchy as IBuildDependencyOnProjectContainer;
        ...
        private void UpdateDependencyListWithSubProjects(IBuildDependencyOnProjectContainer projectNode)
        {
            if (projectNode != null)
            {
                ...
                if (nestedProjectList != null && nestedProjectList.Count > 0)
                {
                    ...
                    foreach (var nestedProject in nestedProjectList)
                    {
            ...
            else
            {
                ...
                var projectList = GetListOfProjectContainerNodes();
        ...
        {
            var projectList = new List<IBuildDependencyOnProjectContainer>();

            Debug.Assert(Solution != null, "IVsSolution object not set on this object");
            if (Solution == null)
            {
            ...
            var guid = Guid.Empty;
            var flags = __VSENUMPROJFLAGS.EPF_LOADEDINSOLUTION;
            ...
            if (enumHierarchies != null)
            {
                ...
                while (enumHierarchies.Next(1, hierarchy, out fetched) == VSConstants.S_OK && fetched == 1)
                {
                    ...
                    var projectNode = hierarchy[0] as IBuildDependencyOnProjectContainer;
                    if (projectNode != null)
                    {
        ...
        private static void AddBuildDependenyToNestedProject(IBuildDependencyUpdate projectContainer,
            IVsHierarchy nestedProject)
        {
            // Validate input
            ...
            var dependency = new NestedProjectBuildDependency(nestedProject);
