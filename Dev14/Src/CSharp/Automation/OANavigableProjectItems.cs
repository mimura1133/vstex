    ...
    public class OANavigableProjectItems : ProjectItems
    {
        ...
        protected IList<ProjectItem> GetListOfProjectItems()
        {
            return UIThread.DoOnUIThread(delegate
            {
                ...
                {
                    var item = child.GetAutomationObject() as ProjectItem;
                    if (null != item)
                    {
                        list.Add(item);
                    }
        ...
        /// </summary>
        internal IList<ProjectItem> Items { get; }

        /// <summary>
        ///     Defines a relationship to the associated project.
        /// </summary>
        internal OAProject Project { get; }

        /// <summary>
        ///     Defines the node that contains the items
        /// </summary>
        internal HierarchyNode NodeWithItems { get; }
        ...
        /// <param name="kind">
        ///     The type of folder to add. The available values are based on vsProjectItemsKindConstants and
        ///     vsProjectItemKindConstants
        /// </param>
        /// <returns>A ProjectItem object.</returns>
