...
namespace VsTeXProject.VisualStudio.Project.Automation
{
    ...
    public class OAProperties : Properties
    {
        ...
        /// <summary>
        ///     Add properties to the collection of properties filtering only those properties which are com-visible and
        ///     AutomationBrowsable
        /// </summary>
        ...
        {
            var customAttributesOnProperty = propertyInfo.GetCustomAttributes(typeof (AutomationBrowsableAttribute),
                true);
