...
namespace VsTeXProject.VisualStudio.Project.Automation
{
        ...
        where T : HierarchyNode
    {
        ...
        /// <summary>
        ///     If the project item is the root of a subproject, then the SubProject property returns the Project object for the
        ///     subproject.
        /// </summary>
        ...
        public virtual string Name
        {
            ...
            set
            {
                ...
                {
                    using (var scope = new AutomationScope(Node.ProjectMgr.Site))
                    {
        ...
        ///     The file name with which to save the solution, project, or project item. If the file exists,
        ///     it is overwritten.
        /// </param>
        ...
        public virtual void ExpandView()
        {
            ...
            UIThread.DoOnUIThread(delegate
            {
                using (var scope = new AutomationScope(Node.ProjectMgr.Site))
                {
                    var uiHierarchy = UIHierarchyUtilities.GetUIHierarchyWindow(Node.ProjectMgr.Site,
